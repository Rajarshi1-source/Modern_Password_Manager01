    ...
    def to_dict(self):
        ...
        return {
            ...
            'notifications': {
                ...
                'quietHoursStart': self.notifications_quiet_hours_start.strftime('%H:%M') if hasattr(self.notifications_quiet_hours_start, 'strftime') else str(self.notifications_quiet_hours_start),
                'quietHoursEnd': self.notifications_quiet_hours_end.strftime('%H:%M') if hasattr(self.notifications_quiet_hours_end, 'strftime') else str(self.notifications_quiet_hours_end),
