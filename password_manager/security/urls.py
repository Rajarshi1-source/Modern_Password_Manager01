...
urlpatterns = [
    ...
    path('predictive-expiration/credential/<str:id>/risk/',
    ...
    path('predictive-expiration/fingerprints/',
         predictive_expiration_views.FingerprintIngestView.as_view(),
         name='predictive-expiration-fingerprints'),
