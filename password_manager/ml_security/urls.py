...
urlpatterns = [
    ...
    path('password-strength/check/', views.predict_password_strength, name='password-strength-check'),
    ...
    path('anomaly/detection/', views.detect_session_anomaly, name='anomaly-detection'),
    ...
    path('threat/analysis/', views.analyze_threat, name='threat-analysis'),
